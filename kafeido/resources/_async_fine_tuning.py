...
class AsyncFineTuningJobs:
    """Async fine-tuning jobs endpoint."""
    ...
    async def create(
        ...
        *,
        ...
        response_data = await self._client.post("/v1/fine_tuning/jobs", json=body)
    ...
    async def list(
        ...
        *,
        ...
        response_data = await self._client.get("/v1/fine_tuning/jobs", params=params)
        return FineTuningJobList.model_validate(response_data)

    async def retrieve(self, fine_tuning_job_id: str) -> FineTuningJob:
        """Retrieve a fine-tuning job by ID asynchronously.
    ...
    async def cancel(self, fine_tuning_job_id: str) -> FineTuningJob:
        """Cancel a running fine-tuning job asynchronously.
    ...
    async def list_events(
        ...
        *,
        ...
        """List training progress events asynchronously.
...
class AsyncFineTuning:
    ...
    def __init__(self, http_client: AsyncHTTPClient) -> None:
        self._client = http_client
        self._jobs = AsyncFineTuningJobs(http_client)

    @property
    def jobs(self) -> AsyncFineTuningJobs:
        """Access async fine-tuning jobs endpoint."""
        return self._jobs
